...
export default function CustodianPageBody() {
  const { t } = useLanguage();
  return (
    <>
      <Header breadcrumb={t("menuCustodian")} />
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            <Reveal className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gold-400">
                {t("custodianConnectEyebrow")}
              </p>
              <h2 className="mt-3 font-serif text-3xl font-semibold">
                {t("custodianConnectHeading")}
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-cream-100/75">
                {t("custodianConnectBody")}
              </p>
            </Reveal>
